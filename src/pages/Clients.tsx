                ...
                filtered.map((client, i) => (
                  ...
                  >
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      ...
                      <div style={{ fontSize: 12, fontWeight: 700, color: '#111827', flexShrink: 0, marginLeft: 8 }}>
                        {fmt(client.monthlyTransactionVolume)}/mo
                      </div>
                    </div>
                  </div>
                ))
            ...
            <div style={{ overflowX: 'auto' }}>
              <table style={{ width: '100%', borderCollapse: 'collapse', minWidth: 800 }}>
                ...
                <tbody>
                  {loading ? (
                    <tr>
                      <td colSpan={8} style={{ padding: '48px 22px', textAlign: 'center', color: '#9ca3af', fontSize: 14 }}>Loading…</td>
                    </tr>
                  ) : filtered.length === 0 ? (
                    <tr>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 12 }}>
                          ...
                          {!search && (
                            <div style={{ fontSize: 12, color: '#9ca3af' }}>
                              ...
                              <button onClick={() => navigate('/applications')} style={{ color: '#e8424f', background: 'none', border: 'none', fontSize: 12, fontWeight: 600 }}>
                                Go to Applications →
                              </button>
                            </div>
                          )}
                          ...
                          <div style={{ display: 'flex', gap: 4, flexWrap: 'wrap' }}>
                            {client.accountTypes.map(t => (
                              <span
                                key={t}
                                style={{
                                  fontSize: 10.5, fontWeight: 600, color: '#34d399',
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexShrink: 0, marginLeft: 12 }}>
              ...
              <button
                ...
                style={{
                  ...
                  border: 'none', color: '#6b7280', fontSize: 18,
              ...
              <div key={section.title} style={{ marginBottom: 22 }}>
                <div
                  style={{
                    ...
                    marginBottom: 10, paddingBottom: 6, borderBottom: '1px solid rgba(0,0,0,0.06)',
                  }}
                >
                  {section.title}
                </div>
